...
public struct SettingsView: View {
    ...
    private var audioSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            SectionHeader(title: "Audio Settings", icon: "speaker.wave.2.fill")
            
            VStack(spacing: 0) {
                // ElevenLabs Status
                HStack {
                    Image(systemName: viewModel.hasElevenLabsKey ? "checkmark.circle.fill" : "xmark.circle.fill")
                        .foregroundColor(viewModel.hasElevenLabsKey ? LeavnTheme.Colors.success : LeavnTheme.Colors.error)
                    Text("ElevenLabs Voice")
                        .font(LeavnTheme.Typography.body)
                    Spacer()
                    Text(viewModel.hasElevenLabsKey ? "Configured" : "Not Set")
                        .font(LeavnTheme.Typography.caption)
                        .foregroundColor(.secondary)
                }
                .padding()
                
                if !viewModel.hasElevenLabsKey {
                    Divider().padding(.horizontal)
                    
                    VStack(alignment: .leading, spacing: 12) {
                        Text("Add your ElevenLabs API key for premium voice narration")
                            .font(LeavnTheme.Typography.caption)
                            .foregroundColor(.secondary)
                        ...
                        HStack {
                            ...
                            Link("Get API Key", destination: URL(string: "https://elevenlabs.io/api")!)
                                .font(LeavnTheme.Typography.caption)
                        }
                    }
                    .padding()
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(spacing: 0) {
                HStack {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text("Connect with fellow believers, share insights, and grow together")
                            .font(LeavnTheme.Typography.caption)
                            .foregroundColor(.secondary)
                ...
                HStack {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text("Group Bible Studies")
                            .font(LeavnTheme.Typography.headline)
                            .foregroundColor(.primary)
                        
                        Text("Join or create study groups and discuss scripture together")
                            .font(LeavnTheme.Typography.caption)
                            .foregroundColor(.secondary)
                            .fixedSize(horizontal: false, vertical: true)
                    }
                ...
                HStack {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text("Share verses, testimonies, and encourage one another")
                            .font(LeavnTheme.Typography.caption)
                            .foregroundColor(.secondary)
                            .fixedSize(horizontal: false, vertical: true)
                    }
                ...
                ZStack {
                    ...
                    LinearGradient(
                        gradient: Gradient(colors: [
                            ...
                            LeavnTheme.Colors.info.opacity(0.05)
                        ]),
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 16)
                    .stroke(LeavnTheme.Colors.primaryGradient.opacity(0.3), lineWidth: 1)
            )
        }
    }
