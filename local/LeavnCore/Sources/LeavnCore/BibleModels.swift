...
public extension BibleBook {
    ...
    static var apocrypha: [BibleBook] {
        allCases.filter { $0.testament == .apocrypha }
    }
    ...
    static let allCases: [BibleBook] = [
        ...
        BibleBook(id: "tob", name: "Tobit", abbreviation: "Tob", testament: .apocrypha, chapterCount: 14, bookNumber: 67),
        BibleBook(id: "jdt", name: "Judith", abbreviation: "Jdt", testament: .apocrypha, chapterCount: 16, bookNumber: 68),
        BibleBook(id: "grek", name: "Greek Esther", abbreviation: "GrEs", testament: .apocrypha, chapterCount: 10, bookNumber: 69),
        BibleBook(id: "wis", name: "Wisdom of Solomon", abbreviation: "Wis", testament: .apocrypha, chapterCount: 19, bookNumber: 70),
        BibleBook(id: "sir", name: "Sirach", abbreviation: "Sir", testament: .apocrypha, chapterCount: 51, bookNumber: 71),
        BibleBook(id: "bar", name: "Baruch", abbreviation: "Bar", testament: .apocrypha, chapterCount: 6, bookNumber: 72),
        BibleBook(id: "lje", name: "Letter of Jeremiah", abbreviation: "LJe", testament: .apocrypha, chapterCount: 1, bookNumber: 73),
        BibleBook(id: "s3y", name: "Song of the Three Young Men", abbreviation: "S3Y", testament: .apocrypha, chapterCount: 1, bookNumber: 74),
        BibleBook(id: "sus", name: "Susanna", abbreviation: "Sus", testament: .apocrypha, chapterCount: 1, bookNumber: 75),
        BibleBook(id: "bel", name: "Bel and the Dragon", abbreviation: "Bel", testament: .apocrypha, chapterCount: 1, bookNumber: 76),
        BibleBook(id: "1ma", name: "1 Maccabees", abbreviation: "1Ma", testament: .apocrypha, chapterCount: 16, bookNumber: 77),
        BibleBook(id: "2ma", name: "2 Maccabees", abbreviation: "2Ma", testament: .apocrypha, chapterCount: 15, bookNumber: 78),
        BibleBook(id: "1es", name: "1 Esdras", abbreviation: "1Es", testament: .apocrypha, chapterCount: 9, bookNumber: 79),
        BibleBook(id: "man", name: "Prayer of Manasseh", abbreviation: "Man", testament: .apocrypha, chapterCount: 1, bookNumber: 80),
        BibleBook(id: "ps151", name: "Psalm 151", abbreviation: "Ps151", testament: .apocrypha, chapterCount: 1, bookNumber: 81),
        BibleBook(id: "3ma", name: "3 Maccabees", abbreviation: "3Ma", testament: .apocrypha, chapterCount: 7, bookNumber: 82),
        BibleBook(id: "2es", name: "2 Esdras", abbreviation: "2Es", testament: .apocrypha, chapterCount: 16, bookNumber: 83),
        BibleBook(id: "4ma", name: "4 Maccabees", abbreviation: "4Ma", testament: .apocrypha, chapterCount: 18, bookNumber: 84)
    ]
}
