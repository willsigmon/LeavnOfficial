        ...
        Button(action: {
            ...
            HStack(spacing: 4) {
                Image(systemName: icon)
                    ...
                    .foregroundStyle(isSelected ? 
                        LinearGradient(
                            gradient: Gradient(colors: [LeavnTheme.Colors.accent, LeavnTheme.Colors.accent.opacity(0.8)]),
                            startPoint: .topLeading,
                            endPoint: .bottomTrailing
                        ) : 
                        LinearGradient(
                            gradient: Gradient(colors: [Color.secondary, Color.secondary]),
                            startPoint: .topLeading,
                            endPoint: .bottomTrailing
                        )
                    )
            ...
            .background(
                Capsule()
                    .fill(isSelected ? 
                        LinearGradient(
                            gradient: Gradient(colors: [
                                LeavnTheme.Colors.accent.opacity(0.2),
                                LeavnTheme.Colors.accent.opacity(0.1)
                            ]),
                            startPoint: .topLeading,
                            endPoint: .bottomTrailing
                    ...
                    .shadow(color: isSelected ? LeavnTheme.Colors.accent.opacity(0.3) : .clear, radius: 6, x: 0, y: 3)
            )
        }
        .buttonStyle(PlainButtonStyle())
