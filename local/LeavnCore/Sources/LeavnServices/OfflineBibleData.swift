...
public struct OfflineBibleData {
    ...
    public static let popularVerses: [String: BibleVerse] = [
        ...
        // Apocrypha verses
        "tobit-13-2": BibleVerse(
            id: "tobit-13-2-esv",
            bookName: "Tobit",
            bookId: "tobit",
            chapter: 13,
            verse: 2,
            text: "For he scourges and then has mercy; he casts down to the depths of Hades, and he brings up from the great abyss, and there is nothing that can escape his hand.",
            translation: "ESV"
        ),
        "wisdom-3-1": BibleVerse(
            id: "wisdom-3-1-esv",
        ...
        "sirach-2-1": BibleVerse(
            id: "sirach-2-1-esv",
            bookName: "Sirach",
            bookId: "sirach",
            chapter: 2,
            verse: 1,
            text: "My son, when you come to serve the Lord, prepare yourself for testing.",
            translation: "ESV"
        ),
        "1maccabees-4-59": BibleVerse(
            id: "1maccabees-4-59-esv",
            bookName: "1 Maccabees",
            bookId: "1maccabees",
            chapter: 4,
            verse: 59,
            text: "Then Judas and his brothers and all the assembly of Israel determined that every year at that season the days of dedication of the altar should be observed with joy and gladness for eight days.",
            translation: "ESV"
        ),
        "judith-8-17": BibleVerse(
            id: "judith-8-17-esv",
            bookName: "Judith",
            bookId: "judith",
            chapter: 8,
            verse: 17,
            text: "Do not try to bind the purposes of the Lord our God; for God is not like a human being, to be threatened, or like a mere mortal, to be won over by pleading.",
            translation: "ESV"
        ),
        "baruch-3-37": BibleVerse(
            id: "baruch-3-37-esv",
            bookName: "Baruch",
            bookId: "baruch",
            chapter: 3,
            verse: 37,
            text: "Afterward she appeared on earth and lived with humankind.",
            translation: "ESV"
        )
    ]
    ...
    public static let sampleChapters: [String: BibleChapter] = [
        ...
        "wisdom-3": BibleChapter(
            bookName: "Wisdom of Solomon",
            bookId: "wisdom",
            chapterNumber: 3,
            verses: [
                BibleVerse(id: "wisdom-3-1-esv", bookName: "Wisdom of Solomon", bookId: "wisdom", chapter: 3, verse: 1, text: "But the souls of the righteous are in the hand of God, and no torment will ever touch them.", translation: "ESV"),
                BibleVerse(id: "wisdom-3-2-esv", bookName: "Wisdom of Solomon", bookId: "wisdom", chapter: 3, verse: 2, text: "In the sight of the unwise they seemed to die, and their departure is taken for misery.", translation: "ESV"),
                BibleVerse(id: "wisdom-3-3-esv", bookName: "Wisdom of Solomon", bookId: "wisdom", chapter: 3, verse: 3, text: "And their going from us to be utter destruction: but they are in peace.", translation: "ESV"),
                BibleVerse(id: "wisdom-3-4-esv", bookName: "Wisdom of Solomon", bookId: "wisdom", chapter: 3, verse: 4, text: "For though they be punished in the sight of men, yet is their hope full of immortality.", translation: "ESV"),
                BibleVerse(id: "wisdom-3-5-esv", bookName: "Wisdom of Solomon", bookId: "wisdom", chapter: 3, verse: 5, text: "And having been a little chastised, they shall be greatly rewarded: for God proved them, and found them worthy for himself.", translation: "ESV")
            ]
        )
    ]
